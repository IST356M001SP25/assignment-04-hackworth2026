...
def test_load_file():
    df = load_file('assignment04Hackworth2026/data/grades.csv', 'csv')
    assert df.shape == (8, 5)
    df = load_file('assignment04Hackworth2026/data/grades.xlsx', 'xlsx')
    assert df.shape == (8, 5)
    df = load_file('assignment04Hackworth2026/data/grades.json', 'json')
    assert df.shape == (8, 5)
